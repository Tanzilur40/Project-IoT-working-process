...
\title{IoT Working Process\\
{\footnotesize \textsuperscript{*}Note: Sub-titles are not captured in Xplore and
should not be used}
\thanks{Identify applicable funding agency here. If none, delete this.}
}

\author{\IEEEauthorblockN{1\textsuperscript{st} Tanzilur Rahaman}
\IEEEauthorblockA{\textit{dept. name of CSE (Diploma.)} \\
\textit{name of Organaization (European University of Bangladesh.)}\\
Dhaka, Bangladesh \\
200122123}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Tamanna Afrin}
\IEEEauthorblockA{\textit{dept. name of CSE (Diploma.)} \\
\textit{name of organization (European University of Bangladesh.)}\\
Dhaka, Bangladesh \\
200122139}
\and
\IEEEauthorblockN{3\textsuperscript{rd} Imran Hosan}
\IEEEauthorblockA{\textit{dept. name of CSE ( Diploma.)} \\
\textit{name of organization (European University of Bangladesh.)}\\
Dhaka, Bangladesh \\
200122159}
\and
\IEEEauthorblockN{4\textsuperscript{th} Harun Ur Roshid}
\IEEEauthorblockA{\textit{dept. name of CSE (Diploma.)} \\
\textit{name of organization (European University of Bangladesh.)}\\
Dhaka, Bangladesh \\
200122121}
\and
\IEEEauthorblockN{5\textsuperscript{th} Nahid Mia}
\IEEEauthorblockA{\textit{dept. name of CSE (Diploma.)} \\
\textit{name of organization (European University of Bangladesh.)}\\
Dhaka, Bangladesh \\
200122160
...
\begin{abstract}
Internet of Things IoT wokrknging process \LaTeX.
Here are the all details.
\end{abstract}

\begin{IEEEkeywords}
Table Of Content, History of IOT, Iot Definition, How IoT works?, IoT Applications insert
\end{IEEEkeywords}

\section{Introduction}
Internet of Things IoT \LaTeX.
...
\subsection{Units}
\begin{itemize}
\item Over the past few years, IoT has become one of the most important technologies of the 21st century. 
